...
import { DEMO_DOCTORS, DEMO_FACILITIES, DEMO_VISITING_SESSIONS, DEMO_UPDATES } from "@/lib/mock-data"
...
export function HomePage() {
  ...
  const publicHospital = DEMO_FACILITIES.find(f => f.is_public_hospital)
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2">
            {openNowFacilities.map(facility => {
              const facilityDoctors = DEMO_DOCTORS.filter(d => d.facility_id === facility.id && !d.is_visiting)
